        ...
        <div className="container" style={{padding:"0"}}>
          <InnerWrapper  style={{ display:"flex",justifyContent:"space-between",padding: "30px 0" }}>
            ...
            <div className="flexColumn" style ={{display:"flex",justifyContent:"space-between"}}>
              <h1 className="purpleColor font20" style={{textDecoration:"under-lined"}}>Contact Us</h1>
              <p className="whiteColor font15">Adress : Lala Lajpat Rai Hall of Residence, IIT Kharagpur</p>
